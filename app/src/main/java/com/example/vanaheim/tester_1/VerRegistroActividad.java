        ...
        br = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                for (int i=0; i<actorsList.size();i++ ){
                    registro_actividad[i]= " Valoraste la publicacion " + actorsList.get(i).getIdPublicacion() + " con un " + actorsList.get(i).getRating() + " y comentaste " + actorsList.get(i).getTexto();
                }
